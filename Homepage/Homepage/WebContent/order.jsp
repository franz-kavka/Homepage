...
<body>
	<div class="blue-bg">
		<div class="white-bg shadow">
			<span id="title"><h1>ORDER</h1></span>
		</div>
		<s:include value="header.jsp" />
		<div id="main">
			<div id="form">
				<div id="contents">
					<form action="OrderCompleteAction" method="post"
						onsubmit="return submitChk()">
						以下の内容で注文を確定します。<br> <br>
						<table>
						...
						<br> 郵便番号：
						<s:property value="yubin" />
						<br> 住所：
						<s:property value="pref" />
						<br>
						<s:property value="jusyo" />
						<br>
						<s:property value="tatemono" />
						<br> アドレス：
						...
						<br> <input type="hidden" id="name" name="name"
							...
							name="yubin" value="<s:property value="yubin"/>" /> <input
							type="hidden" name="pref" value="<s:property value="pref"/>" />
						<input type="hidden" name="jusyo"
							value="<s:property value="jusyo"/>" /> <input type="hidden"
							name="tatemono" value="<s:property value="tatemono"/>" /> <input
							type="hidden" name="mail" value="<s:property value="mail"/>" />
						<input type="hidden" name="message"
							value="<s:property value="message"/>" /> <input type="hidden"
							name="payment" value="<s:property value="payment"/>" /> <input
							type="hidden" name="total"
							value="<s:property value="session.total" />" /> <br>
